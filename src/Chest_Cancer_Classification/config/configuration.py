...
class ConfigurationManager:
    ...
    def get_evaluation_config(self) -> EvaluationConfig:
        eval_config = EvaluationConfig(
            ...
            training_data="artifacts/Chest-CT-Scan-data",
            mlflow_uri="https://dagshub.com/data-scientist718/Deep-Learning-Chest-Cancer-Classification-using-MLflow-DVC.mlflow",
